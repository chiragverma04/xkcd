...
$params = array(
    ...
    'text'      => "I'm text!",
    'html'      => "<strong>Click On the Confirmation Code to Verify Your Email Address https://sql6.freemysqlhosting.net/xkcd-image.herokuapp.com/confirmation.php?passkey=$confirm</strong>",
